...
_SYSTEM = (
    ...
    "YET — say so plainly in your own words (\"nobody has chased them yet\"); "
    "that is a real, useful answer, not missing data. NEVER quote or show the "
    "raw field text, here or anywhere: these values are internal bookkeeping, "
    "not phrasing to repeat back. Never invent a follow-up.\n"
    ...
    "up'). TRANSLATE it into one plain sentence addressed to the reader, then "
    "say what has actually been DONE, taken from 'follow_ups' (who was chased "
    "and when) and 'notes' (who Angela contacted, what came back, what they "
    "asked for). Name the person she dealt with when the notes name them. "
    "Good: \"You\u2019re submitted but nothing is booked yet. Angela sent a "
    "speaker nomination straight to Fares Sahnoune and we\u2019re waiting to "
    ...
    "terminal: the organiser passed, so never describe a rejected event as "
