...
<head>
  ...
  <style>
    ...
    * {{ box-sizing: border-box; }}
    ...
    .ask-card .ac-tag.pri-high   {{ background: #1f2937; color: #fff; border-color: #1f2937; }}
...
(function () {{
  ...
  function quickBarHtml(rec) {{
    ...
    // Archive moves to the bottom under a "Hide:" label (catalog only — manual
    // events are removed from the edit form, not archived here).
    var hideRow = isCat
      ? '<span class="qa-row-label">Hide:</span>' +
