  ...
  <style>
    ...
    * {{ box-sizing: border-box; }}
    ...
    .chat-act {{
      ...
      border: 0; background: none; cursor: pointer; font-size: 0.95rem; line-height: 1;
      border-radius: 6px; color: var(--ab-fg-2); overflow: visible;
    }}
    .chat-act:hover {{ background: var(--ab-bg-3); }}
    .chat-act-del {{ color: var(--ab-fg-3); font-size: 1.1rem; }}
  ...
  ready(function () {{
    ...
    function _paintChatList(list, msgs) {{
      ...
      msgs.forEach(function (m) {{
        ...
        // Slack-style hover toolbar: add-to-notes · 👍 · 👎 · delete (own, or any
        // for support).
        var actions = '<div class="chat-actions">' +
          ...
          (canDel ? '<button type="button" class="chat-act chat-act-del" data-act="del" title="' + (mine ? 'Delete your message' : 'Delete this message') + '" aria-label="Delete message">\\u00d7</button>' : '') +
          '</div>';
