...
(function () {{
  ...
  ready(function () {{
    ...
    function applyFilters() {{
      ...
      [['ops-f-saved',$saved],['ops-f-urgent',$urgent],['ops-f-speaker',$speaker],['ops-f-buyers',$buyers],['ops-f-meetings',$meet],['ops-f-worth',$worth],['ops-f-past',$past],['ops-f-hidden',$hidden],['ops-f-nogo',$nogo],['ops-f-recent',$recent]].forEach(function (pair) {{
    ...
    function wireFilters() {{
      ...
      ['ops-search','ops-region','ops-price','ops-fits','ops-f-saved','ops-f-urgent','ops-f-speaker','ops-f-buyers','ops-f-meetings','ops-f-worth','ops-f-past','ops-f-hidden','ops-f-nogo','ops-f-recent'].forEach(function (id) {{
    ...
    function clearOpsFilters() {{
      ...
      ['ops-f-saved','ops-f-urgent','ops-f-speaker','ops-f-buyers','ops-f-meetings','ops-f-worth','ops-f-past','ops-f-hidden','ops-f-nogo','ops-f-recent'].forEach(function (id) {{
