    ...
    window.opsRenderChat = function (rec) {{
      ...
      if (a1) a1.addEventListener('submit', function (e) {{
        ...
        fetch('/api/ask', {{
          ...
          // Nothing is written. Asking the assistant is a private lookup, not a
          // message to the team — posting it turned every question into a chat
          // row in a thread meant for actual conversation (Hurley 2026-07-30).
