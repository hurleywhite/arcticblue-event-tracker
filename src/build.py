...
<head>
  ...
  <style>
    ...
    * {{ box-sizing: border-box; }}
    ...
    .ops-myevents, .ops-planahead, .ops-queue, .ops-planner, .ops-dayof {{ display: none; }}
    .ops-myevents.show, .ops-planahead.show, .ops-queue.show, .ops-planner.show, .ops-dayof.show {{ display: block; }}
    /* ── Day-Of tab ─────────────────────────────────────────────── */
...
(function () {{
  ...
  ready(function () {{
    ...
    var VIEW_NAMES = ['myevents', 'planahead', 'grid', 'calendar', 'map', 'queue', 'planner', 'dayof'];
